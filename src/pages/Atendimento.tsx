...
const Atendimento = () => {
  ...
  const saveVitalSigns = async () => {
    ...
    try {
      ...
      await apiService.savePatientVitalSigns(vitalSignsData);
  ...
  const saveConsultation = async () => {
    ...
    try {
      const consultationDataToSave = {
        ...
        hipotese_diagnostica: consultationData.hipotese,
      ...
      await apiService.createMedicalRecord(consultationDataToSave);
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center p-4 bg-muted/50 rounded-lg">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>Última atualização: Hoje às 14:25</span>
          </div>
